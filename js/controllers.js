...
.controller('HomeCtrl', function($scope, TemplateService, NavigationService, $timeout) {
  ...
  $scope.savenewsletter = function(email) {
    if (email && email != "") {
      ...
      $scope.newsletter.emaildis = false;
    } else {
      $scope.newsletter.emaildis = true;
    }
  }
...
.controller('SchoolCtrl', function($scope, TemplateService, NavigationService, $timeout, ngDialog, $location) {
  ...
  $scope.goToSchool = function(school) {
    $location.url("/schoolprofile/" + school.id + "-" + school.name.split(' ').join('_'));
  }
...
.controller('StudentCtrl', function($scope, TemplateService, NavigationService, $timeout, ngDialog, $location) {
  ...
  $scope.goToSchool = function(student) {
    console.log(student);
    $location.url("/schoolprofile/" + student.schoolid + "-" + student.school.split(' ').join('_'));
  }
...
.controller('DrawCtrl', function($scope, TemplateService, NavigationService) {
  ...
  $scope.sportChange = function() {
    ...
    var obj = _.cloneDeep($scope.filter);
    if (obj.sport && obj.sport == "table tennis") {
      obj.sport = "tabletennis";
    }
    NavigationService.getDropdowns(obj, function(data) {
  ...
  $scope.getDraw = function() {
    ...
    NavigationService.getDraw(obj, function(data) {
      $scope.match = [];
      $scope.round = [];
      $scope.rounds = [];
