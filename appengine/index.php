...
<html lang="en" ng-app="firstapp">
    ...
    <head ng-controller="headerctrl">
        ...
        <!--[if IE]><script src="https://cdn.jsdelivr.net/html5shiv/3.7.2/html5shiv.min.js"></script> <script src="https://cdn.jsdelivr.net/respond/1.4.2/respond.min.js"></script><![endif]-->
    ...
    <body>
        ...
        <noscript>
            <iframe src="//www.googletagmanager.com/ns.html?id=GTM-K98G4P" height="0" width="0" style="display:none;visibility:hidden"></iframe>
        </noscript>
        <script>
            (function(w, d, s, l, i) {
                w[l] = w[l] || [];
            ...
            })(window, document, 'script', 'dataLayer', 'GTM-K98G4P');
        </script>
        ...
        <script type="text/javascript">
            window.$zopim || (function(d, s) {
                ...
                $.src = "//v2.zopim.com/?3Nwhrdv7gDoKNpauyfJgkwTrI8mvEjcl";
                z.t = +new Date;
