 ...
 .factory('NavigationService', function($http) {
     ...
     return {
         ...
         getSwimmingStats: function(obj, callback) {
             return $http.get(admin_url + 'json/getSwimmingMatch?schoolid=' + obj.schoolid + '&studentid=' + obj.studentid + "&gender=" + obj.gender + "&agegroup=" + obj.agegroup, {}).success(callback);
         },
         getMedalsTally: function(obj, callback) {
             return $http.get(admin_url + 'json/getMedalsTally?schoolid=' + obj.schoolid + '&sport=' + obj.sportscategory + "&gender=" + obj.gender + "&agegroup=" + obj.agegroup, {}).success(callback);
         },
